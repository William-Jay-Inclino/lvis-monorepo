...
import { UpdateMEQSSettingOrderInput } from './dto/update-meqs-setting-order.input';
...
export class MeqsApproverSettingResolver {
  ...
  @Mutation(() => UpdateMeqsSettingOrderResponse)
  async updateMEQSApproverSettingOrder(@Args('inputs', { type: () => [UpdateMEQSSettingOrderInput] }) inputs: UpdateMEQSSettingOrderInput[]) {

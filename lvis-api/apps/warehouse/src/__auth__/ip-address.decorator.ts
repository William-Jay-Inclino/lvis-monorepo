...
export const IpAddress = createParamDecorator(
	(_data: unknown, context: ExecutionContext): string | null => {
		...
		try {
			...
			// First, try to get the 'x-forwarded-for' header, which may contain a chain of IPs
			...
			// Fallback to 'req.connection.remoteAddress' if 'x-forwarded-for' is not available

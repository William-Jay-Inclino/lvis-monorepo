                ...
                <div style="display: flex; justify-content: space-between;">
                    ...
                    <div>
                        <table style="font-size: 10pt; width: 150px;">
                            ...
                            <tr>
                                <td>MRV No.:</td>
                                <td style="border-bottom: 1px solid black; font-weight: bold;"> ${ mct.mrv.mrv_number } </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div>
                        <table style="font-size: 10pt; width: 150px;">
                            ...
                            <tr>
                                <td>OR No.</td>
                                <td style="border-bottom: 1px solid black; font-weight: bold;"> ${ mct.mrv.or_number } </td>
                            </tr>
                            ` : ''}
                            ${ mct.mrv.mwo_number ? `
                                <tr>
                                    <td>MWO No.</td>
                                    <td style="border-bottom: 1px solid black; font-weight: bold;"> ${ mct.mrv.mwo_number } </td>
                                </tr>
                                ` : ''}
                            ${ mct.mrv.cwo_number ? `
                            <tr>
                                <td>CWO No.</td>
                                <td style="border-bottom: 1px solid black; font-weight: bold;"> ${ mct.mrv.cwo_number } </td>
                            </tr>
                            ` : ''}
                            ${ mct.mrv.jo_number ? `
                                <tr>
                                    <td>JO No.</td>
                                    <td style="border-bottom: 1px solid black; font-weight: bold;"> ${ mct.mrv.jo_number } </td>
                                </tr>
                                ` : ''}
                        </table>
                    </div>

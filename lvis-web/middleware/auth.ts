...
function canAccessProject(route: ROUTES, permissions: WarehousePermissions) {

    console.log('canAccessProject', route, permissions)

    if (!permissions.canManageProject) return false

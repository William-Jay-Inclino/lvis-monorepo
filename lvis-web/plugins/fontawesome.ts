...
library.add(
  ...
  faRefresh, faExclamationTriangle, faClock, faClipboardList, faTasks, faRoad, faFilter, faArrowRight, faCalendar, faFilePdf, faDownload
);

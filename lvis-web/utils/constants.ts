...
export enum ROUTES {
    ...
    CUSTCARE_DASHBOARD = `${SERVICES.POWERSERVE}_CUSTCARE_DASHBOARD`,
    LINEMAN_DASHBOARD = `${SERVICES.POWERSERVE}_LINEMAN_DASHBOARD`,
    ...
    TASK_CREATE = `${SERVICES.POWERSERVE}_TASK_CREATE`,
    TASK_UPDATE = `${SERVICES.POWERSERVE}_TASK_UPDATE`,
    TASK_VIEW = `${SERVICES.POWERSERVE}_TASK_VIEW`,

    PENDING_TASK_INDEX = `${SERVICES.POWERSERVE}_PENDING_TASK_INDEX`,

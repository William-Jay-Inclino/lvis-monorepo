...
export enum MODULES {
    ...
    LINEMAN_EVALUATION = 'LINEMAN_EVALUATION',
    MY_PERFORMANCE = 'MY_PERFORMANCE',
    POWERSERVE_ACTIVITY = 'POWERSERVE_ACTIVITY',
    AREA = 'AREA',
...
export enum ROUTES {
    ...
    OSRIV_SUMMARY_REPORT = `${SERVICES.WAREHOUSE}_OSRIV_SUMMARY_REPORT`,
    ...
    SERIV_SUMMARY_REPORT = `${SERVICES.WAREHOUSE}_SERIV_SUMMARY_REPORT`,
    ...
    MCT_SUMMARY_REPORT = `${SERVICES.WAREHOUSE}_MCT_SUMMARY_REPORT`,
    ...
    MCRT_SUMMARY_REPORT = `${SERVICES.WAREHOUSE}_MCRT_SUMMARY_REPORT`,
    ...
    ITEM_UPDATE_PRICES = `${SERVICES.WAREHOUSE}_ITEM_UPDATE_PRICES`,
    ITEM_VIEW = `${SERVICES.WAREHOUSE}_ITEM_VIEW`,
    ITEM_SUMMARY_REPORT = `${SERVICES.WAREHOUSE}_ITEM_SUMMARY_REPORT`,
    ...
    // =======================  VEHICLE MAINTENANCE ======================= 
    VEHICLE_MAINTENANCE_INDEX = `${SERVICES.WAREHOUSE}_VEHICLE_MAINTENANCE_INDEX`,
    VEHICLE_MAINTENANCE_CREATE = `${SERVICES.WAREHOUSE}_VEHICLE_MAINTENANCE_CREATE`,
    VEHICLE_MAINTENANCE_UPDATE = `${SERVICES.WAREHOUSE}_VEHICLE_MAINTENANCE_UPDATE`,
    VEHICLE_MAINTENANCE_VIEW = `${SERVICES.WAREHOUSE}_VEHICLE_MAINTENANCE_VIEW`,

    // =======================  VEHICLE SERVICE ======================= 
    VEHICLE_SERVICE_INDEX = `${SERVICES.WAREHOUSE}_VEHICLE_SERVICE_INDEX`,
    VEHICLE_SERVICE_CREATE = `${SERVICES.WAREHOUSE}_VEHICLE_SERVICE_CREATE`,
    VEHICLE_SERVICE_UPDATE = `${SERVICES.WAREHOUSE}_VEHICLE_SERVICE_UPDATE`,
    VEHICLE_SERVICE_VIEW = `${SERVICES.WAREHOUSE}_VEHICLE_SERVICE_VIEW`,

    // =======================  SERVICES ======================= 
    SERVICES_INDEX = `${SERVICES.WAREHOUSE}_SERVICES_INDEX`,
    SERVICES_CREATE = `${SERVICES.WAREHOUSE}_SERVICES_CREATE`,
    SERVICES_UPDATE = `${SERVICES.WAREHOUSE}_SERVICES_UPDATE`,
    SERVICES_VIEW = `${SERVICES.WAREHOUSE}_SERVICES_VIEW`,
    ...
    TRIP_TICKET_SUMMARY_REPORT = `${SERVICES.WAREHOUSE}_TRIP_TICKET_SUMMARY_REPORT`,
    TRIP_TICKET_PER_VEHICLE_TYPE_REPORT = `${SERVICES.WAREHOUSE}_TRIP_TICKET_PER_VEHICLE_TYPE_REPORT`,
    ...
    OIC_DASHBOARD = `${SERVICES.POWERSERVE}_OIC_DASHBOARD`,
    ...
    // ======================= TASK ======================= 
    TASK_INDEX = `${SERVICES.POWERSERVE}_TASK_INDEX`,
    MY_TASK_INDEX = `${SERVICES.POWERSERVE}_TASK_VIEW`,

    // ======================= AREA ======================= 
    AREA_INDEX = `${SERVICES.POWERSERVE}_AREA_INDEX`,
    AREA_CREATE = `${SERVICES.POWERSERVE}_AREA_CREATE`,
    AREA_UPDATE = `${SERVICES.POWERSERVE}_AREA_UPDATE`,
    AREA_VIEW = `${SERVICES.POWERSERVE}_AREA_VIEW`,

    // =======================  MUNICIPALITY ======================= 
    MUNICIPALITY_INDEX = `${SERVICES.POWERSERVE}_MUNICIPALITY_INDEX`,
    MUNICIPALITY_CREATE = `${SERVICES.POWERSERVE}_MUNICIPALITY_CREATE`,
    MUNICIPALITY_UPDATE = `${SERVICES.POWERSERVE}_MUNICIPALITY_UPDATE`,
    MUNICIPALITY_VIEW = `${SERVICES.POWERSERVE}_MUNICIPALITY_VIEW`,

    // =======================  BARANGAY ======================= 
    BARANGAY_INDEX = `${SERVICES.POWERSERVE}_BARANGAY_INDEX`,
    BARANGAY_CREATE = `${SERVICES.POWERSERVE}_BARANGAY_CREATE`,
    BARANGAY_UPDATE = `${SERVICES.POWERSERVE}_BARANGAY_UPDATE`,
    BARANGAY_VIEW = `${SERVICES.POWERSERVE}_BARANGAY_VIEW`,

    // =======================  SITIO ======================= 
    SITIO_INDEX = `${SERVICES.POWERSERVE}_SITIO_INDEX`,
    SITIO_CREATE = `${SERVICES.POWERSERVE}_SITIO_CREATE`,
    SITIO_UPDATE = `${SERVICES.POWERSERVE}_SITIO_UPDATE`,
    SITIO_VIEW = `${SERVICES.POWERSERVE}_SITIO_VIEW`,

    // =======================  LINEMAN ======================= 
    LINEMAN_INDEX = `${SERVICES.POWERSERVE}_LINEMAN_INDEX`,
    LINEMAN_SCHEDULE_INDEX = `${SERVICES.POWERSERVE}_LINEMAN_SCHEDULE_INDEX`,
    LINEMAN_EVALUATION_INDEX = `${SERVICES.POWERSERVE}_LINEMAN_EVALUATION_INDEX`,
    MY_PERFORMANCE_INDEX = `${SERVICES.POWERSERVE}_MY_PERFORMANCE_VIEW`,

    // =======================  ACTIVITY ======================= 
    ACTIVITY_INDEX = `${SERVICES.POWERSERVE}_ACTIVITY_INDEX`,
    ACTIVITY_CREATE = `${SERVICES.POWERSERVE}_ACTIVITY_CREATE`,
    ACTIVITY_UPDATE = `${SERVICES.POWERSERVE}_ACTIVITY_UPDATE`,
    ACTIVITY_VIEW = `${SERVICES.POWERSERVE}_ACTIVITY_VIEW`,

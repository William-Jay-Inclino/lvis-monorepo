<template>
    ...
    <div v-if="authUser">
        ...
        <div class="card">
            <div class="card-body">
                <div class="container">
                    <h1 class="text-warning mt-5"> WELCOME TO HUMAN RESOURCE MANAGEMENT </h1>
                    <div class="row text-muted mb-5 mt-4">
                        <div class="col-lg-6 col-md-6 col-12">
                            "Empower your workforce with seamless HR solutions. Manage employee records, payroll, attendance, and performance all in one place."
                            <br />
                            <br />
                            - Admin
                            <client-only>

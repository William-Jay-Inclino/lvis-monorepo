                                            ...
                                            <tr v-for="i in filteredItems">
                                                ...
                                                <td class="text-center">
                                                    <div class="d-inline-flex">
                                                        ...
                                                        <button :disabled="!canEdit(authUser, 'canManageDepartment', SERVICES.SYSTEM)"
...
const onClickCreate = () => router.push('/hr/department/create')
const onClickEdit = (id: string) => router.push('/hr/department/' + id)

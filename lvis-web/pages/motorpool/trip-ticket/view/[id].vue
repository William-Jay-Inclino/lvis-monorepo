...
import * as api from '~/composables/motorpool/trip-ticket/trip-ticket.api'
...
async function cancelTripTicket() {
    ...
    if (response.success) {
        ...
        router.push('/motorpool/trip-ticket')
...
const onClickUpdate = (id: string) => router.push('/motorpool/trip-ticket/' + id)

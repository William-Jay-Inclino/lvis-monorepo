...
import type { CreateTripTicket } from '~/composables/motorpool/trip-ticket/trip-ticket.types';
import type { Employee } from '~/composables/hr/employee/employee.types';
import { addPropertyFullName } from '~/composables/hr/employee/employee';
import { TRIP_TICKET_DEFAULT_APPROVERS } from '~/composables/motorpool/trip-ticket/trip-ticket.constants';

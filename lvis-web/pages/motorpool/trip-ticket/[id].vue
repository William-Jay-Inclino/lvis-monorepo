                ...
                <div class="row justify-content-center pt-3">
                    <div :class="{ 'col-lg-6': form === FORM.UPDATE_INFO || form === FORM.UPDATE_APPROVERS }">
                        ...
                        <div class="d-flex justify-content-between pt-3">
                            <div>
                                <nuxt-link class="btn btn-secondary" :to="`/motorpool/trip-ticket/view/${tripTicket.id}`">
                                    <client-only>
...
import * as tripApi from '~/composables/motorpool/trip-ticket/trip-ticket.api'
import * as tripApproverApi from '~/composables/motorpool/trip-ticket/trip-ticket-approver.api'
import { type TripTicket, type UpdateTripTicket } from '~/composables/motorpool/trip-ticket/trip-ticket.types';
...
async function updateTripInfo() {
    ...
    if (response.success && response.data) {
        ...
        router.push(`/motorpool/trip-ticket/view/${response.data.id}`);
    } else {
        Swal.fire({
            title: 'Error!',
            text: response.msg,

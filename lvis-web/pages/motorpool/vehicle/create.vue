...
import type { CreateVehicleInput } from '~/composables/motorpool/vehicle/vehicle.types'
import Swal from 'sweetalert2'
import { addPropertyFullName } from '~/composables/hr/employee/employee';
import type { Employee } from '~/composables/hr/employee/employee.types';
import { VEHICLE_CLASSIFICATIONS } from '~/composables/motorpool/vehicle/vehicle.constants';
...
async function onSubmit() {
    ...
    if (response.success && response.data) {
        ...
        router.push(`/motorpool/vehicle/view/${response.data.id}`);

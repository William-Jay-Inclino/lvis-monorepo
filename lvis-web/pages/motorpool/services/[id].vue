    ...
    <div class="card">
        <div class="card-body">
            ...
            <div v-if="!isLoadingPage">
                ...
                <h2 class="text-warning">Update Service</h2>
...
import type { UpdateVehicleService, VehicleService } from '~/composables/motorpool/vehicle-service/vehicle-service.types'
import Swal from 'sweetalert2'

definePageMeta({
    name: ROUTES.VEHICLE_SERVICE_UPDATE,
...
async function onSubmit() {
    ...
    const data: UpdateVehicleService = {

        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-12 col-sm-6 col-md-4 pb-5">
                <div class="card shadow mx-auto" style="max-width: 13rem;">
                    ...
                    <div class="card-footer text-center">
                        <button data-testid="purchasing" @click="goToPurchasing" class="btn" :class="{'btn-primary': canViewPurchasing, 'btn-secondary': !canViewPurchasing}" :disabled="!canViewPurchasing"> PURCHASING {{ !canViewPurchasing ? '(Restricted)' : ''  }}</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 pb-5">
                <div class="card shadow mx-auto" style="max-width: 13rem;">
                    ...
                    <div class="card-footer text-center">
                        <button data-testid="warehouse" @click="goToWarehouse" class="btn" :class="{'btn-primary': canViewWarehouse, 'btn-secondary': !canViewWarehouse}" :disabled="!canViewWarehouse"> WAREHOUSE {{ !canViewWarehouse ? '(Restricted)' : ''  }}</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 pb-5">
                <div class="card shadow mx-auto" style="max-width: 13rem;">
                    ...
                    <div class="card-footer text-center">
                        <button data-testid="accounting" @click="goToAccounting" class="btn" :class="{'btn-primary': canViewAccounting, 'btn-secondary': !canViewAccounting}" :disabled="!canViewAccounting"> ACCOUNTING {{ !canViewAccounting ? '(Restricted)' : ''  }}</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 pb-5">
                <div class="card shadow mx-auto" style="max-width: 13rem;">
                    ...
                    <div class="card-footer text-center">
                        <button data-testid="hr" @click="goToHR" class="btn" :class="{'btn-primary': canViewHR, 'btn-secondary': !canViewHR}" :disabled="!canViewHR"> HR {{ !canViewHR ? '(Restricted)' : ''  }}</button>
                    </div>
                </div>
            </div>

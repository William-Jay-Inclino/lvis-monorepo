                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <nuxt-link class="btn btn-sm btn-light text-primary"
                                :to="'/purchase/canvass/view/' + canvass.id" target="_blank">View canvass
                                details</nuxt-link>
                        </div>
...
import type { Canvass, UpdateCanvassInput } from '~/composables/purchase/canvass/canvass.types';
import * as canvassApi from '~/composables/purchase/canvass/canvass.api'
import * as canvassItemApi from '~/composables/purchase/canvass/canvass-item.api'

            ...
            <div v-if="!isLoadingPage && authUser" class="row justify-content-center">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div v-if="item.rv">
                                                        <nuxt-link :to="'/purchase/rv/view/' + item.rv.id">{{
                item.rv.rv_number }}</nuxt-link>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div v-if="item.jo">
                                                        <nuxt-link :to="'/purchase/jo/view/' + item.jo.id">{{
                item.jo.jo_number }}</nuxt-link>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div v-if="item.spr">
                                                        <nuxt-link :to="'/purchase/spr/view/' + item.spr.id">{{
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div v-if="item.rv && item.rv.meqs">
                                                        <nuxt-link :to="'/purchase/meqs/view/' + item.rv.meqs.id">
                                                            {{ item.rv.meqs.meqs_number }}
                                                        </nuxt-link>
                                                    </div>
                                                    <div v-else-if="item.jo && item.jo.meqs">
                                                        <nuxt-link :to="'/purchase/meqs/view/' + item.jo.meqs.id">
                                                            {{ item.jo.meqs.meqs_number }}
                                                        </nuxt-link>
                                                    </div>
                                                    <div v-else-if="item.spr && item.spr.meqs">
                                                        <nuxt-link :to="'/purchase/meqs/view/' + item.spr.meqs.id">

                ...
                <div v-show="currentStep === 1" class="row justify-content-center pt-5">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <client-only>
                                <v-select data-testid="requisitioner" @search="handleSearchEmployees" :options="employees" label="fullname" v-model="formData.requested_by"></v-select>
                            </client-only>
                ...
                <div class="row justify-content-center pt-5">
                    <div :class="{ 'col-lg-6': currentStep === 1, 'col-lg-10 col-md-10 col-sm-12': currentStep === 2 }">
                        ...
                        <div v-if="currentStep === 1" class="d-flex justify-content-between">
                            <nuxt-link class="btn btn-secondary" to="/purchase/canvass">
                                <client-only>
                                <font-awesome-icon :icon="['fas', 'chevron-left']"/>
                            </client-only> Back to Search
                            </nuxt-link>
                            <button data-testid="next" @click="onClickNextStep1()" type="button" class="btn btn-primary">
                                <client-only>
                        ...
                        <div v-else class="d-flex justify-content-between">
                            ...
                            <button data-testid="save" @click="save()" :disabled="formData.canvass_items.length === 0 || isSaving" type="button"
...
import type { CreateCanvassInput } from '~/composables/purchase/canvass/canvass.types';
...
async function save() {
    ...
    if (response.success && response.data) {
        ...
        router.push(`/purchase/canvass/view/${response.data.id}`);
    } else {
        Swal.fire({
            title: 'Error!',
            text: response.msg,

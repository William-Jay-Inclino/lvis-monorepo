            ...
            <div v-if="!isLoadingPage">
                ...
                approvalStatus[option.status].label
                                            ...
                                            <nuxt-link v-if="meqsData.rv" class="btn btn-sm btn-light text-primary"
                                                :to="'/purchase/rv/view/' + meqsData.rv.id" target="_blank">View RV
                                                details</nuxt-link>
                                        </div>
                ...
                approvalStatus[option.status].label
                                            ...
                                            <nuxt-link v-if="meqsData.jo" class="btn btn-sm btn-light text-primary"
                                                :to="'/purchase/jo/view/' + meqsData.jo.id" target="_blank">View JO
                                                details</nuxt-link>
                                        </div>
                ...
                approvalStatus[option.status].label
                                            ...
                                            <nuxt-link v-if="meqsData.spr" class="btn btn-sm btn-light text-primary"
                                                :to="'/purchase/spr/view/' + meqsData.spr.id" target="_blank">View
...
import type { CanvassItemWithSuppliers, CreateMeqsInput, CreateMeqsSupplierSubInput } from '~/composables/purchase/meqs/meqs.types';
...
import { fetchJOsByJoNumber } from '~/composables/purchase/jo/jo.api';
import { fetchSPRsBySprNumber } from '~/composables/purchase/spr/spr.api';
import { fetchRVsByRvNumber } from '~/composables/purchase/rv/rv.api';

                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <nuxt-link v-if="sprData.canvass" class="btn btn-sm btn-light text-primary"
                                        :to="'/purchase/canvass/view/' + sprData.canvass.id" target="_blank">View
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea v-if="sprData.canvass" :value="sprData.canvass.notes" class="form-control form-control-sm"
                                        rows="5" readonly> </textarea>
                                    <textarea v-else class="form-control form-control-sm" rows="5" readonly> </textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <client-only>
                                        <v-select @search="handleSearchEmployees" :options="supervisors" label="fullname" v-model="sprData.supervisor"></v-select>
                                    </client-only>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control form-control-sm" rows="5" v-model="sprData.notes"></textarea>
                                </div>
        
                                <div class="d-flex justify-content-between">
                                    <nuxt-link class="btn btn-secondary" to="/purchase/spr">
                                        <client-only>
...
import type { CreateSprInput } from '~/composables/purchase/spr/spr.types';
import type { Employee } from '~/composables/hr/employee/employee.types';
import { fetchCanvassesByRcNumber } from '~/composables/purchase/canvass/canvass.api';
...
async function save() {
    ...
    if (response.success && response.data) {
        ...
        router.push(`/purchase/spr/view/${response.data.id}`);
    } else {
        Swal.fire({
            title: 'Error!',
            text: response.msg,

                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <nuxt-link class="btn btn-sm btn-light text-primary"
                                :to="'/purchase/canvass/view/' + sprData.canvass.id" target="_blank">View canvass
                                details</nuxt-link>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea :value="sprData.canvass.purpose" class="form-control form-control-sm" rows="5" readonly> </textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">
                                Requisitioner Notes
                            </label>
                            <textarea :value="sprData.canvass.notes" class="form-control form-control-sm" rows="5" readonly> </textarea>
                        </div>
                ...
                <div class="row justify-content-center pt-3">
                    <div :class="{ 'col-lg-6': isSPRDetailForm, 'col-12': !isSPRDetailForm }">
                        ...
                        <div class="d-flex justify-content-between pt-3">
                            <div>
                                <nuxt-link class="btn btn-secondary" :to="`/purchase/spr/view/${sprData.id}`">
                                    <client-only>

                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <nuxt-link class="btn btn-sm btn-light text-primary"
                                :to="'/purchase/po/view/' + poData.id" target="_blank">View PO
                                details</nuxt-link>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" :value="poData.meqs_supplier.meqs!.meqs_number"
                                disabled>
                            <nuxt-link class="btn btn-sm btn-light text-primary"
                                :to="'/purchase/meqs/view/' + poData.meqs_supplier.meqs!.id"
                                target="_blank">View
                ...
                <div class="row justify-content-center pt-3">
                    <div :class="{ 'col-lg-6': isPODetailForm, 'col-12': !isPODetailForm }">
                        <div class="d-flex justify-content-between pt-3">
                            <div>
                                <nuxt-link class="btn btn-secondary" :to="`/purchase/po/view/${poData.id}`">
                                    <client-only>
...
import type { PO, UpdatePoInput } from '~/composables/purchase/po/po.types';
...
async function updatePoInfo() {
    ...
    if (response.success && response.data) {
        ...
        router.push(`/purchase/po/view/${response.data.id}`);

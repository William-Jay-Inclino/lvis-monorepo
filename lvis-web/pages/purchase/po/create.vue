            ...
            <div v-if="!isLoadingPage && authUser">
                ...
                approvalStatus[option.status].label
                                    ...
                                    <nuxt-link v-if="selectedMeqs" class="btn btn-sm btn-light text-primary"
                                        :to="'/purchase/meqs/view/' + selectedMeqs.id" target="_blank">View MEQS
                                        details</nuxt-link>
                                </div>
...
import type { CreatePoInput } from '~/composables/purchase/po/po.types';
...
import { fetchMeqsByMeqsNumber } from '~/composables/purchase/meqs/meqs.api';

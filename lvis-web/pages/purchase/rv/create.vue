                        ...
                        <div class="row justify-content-center pt-3">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <client-only>
                                        <v-select data-testid="rc-number" @search="handleSearchRcNumber" @option:selected="onRcNumberSelected" :options="canvasses" label="rc_number"
                                    ...
                                    <nuxt-link v-if="rvData.canvass" class="btn btn-sm btn-light text-primary"
                                        :to="'/purchase/canvass/view/' + rvData.canvass.id" target="_blank">View
                                ...
                                <div class="mb-3">
                                    ...
                                    <client-only>
                                        <v-select data-testid="supervisor" @search="handleSearchEmployees" :options="supervisors" label="fullname" v-model="rvData.supervisor"></v-select>
                                    </client-only>
                                ...
                                <div class="d-flex justify-content-between">
                                    <nuxt-link class="btn btn-secondary" to="/purchase/rv">
                                        <client-only>
...
import type { CreateRvInput } from '~/composables/purchase/rv/rv.types';
...
async function save() {
    ...
    if (response.success && response.data) {
        ...
        router.push(`/purchase/rv/view/${response.data.id}`);
    } else {
        Swal.fire({
            title: 'Error!',
            text: response.msg,

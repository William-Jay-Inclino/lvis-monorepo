                                    ...
                                    <table class="table table-bordered table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <nuxt-link v-if="item.canvass_number" :to="'/purchase/canvass/view/' + item.canvass_number">{{ item.canvass_number }}</nuxt-link>
                                                    <div v-else> N/A </div>
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="col">
                                <div class="d-flex justify-content-center flex-wrap gap-2">
                                    ...
                                    <template v-if="!item.cancelled_at">
                                        ...
                                        <button v-if="canCreate(authUser, 'canManageRV')" class="btn btn-primary" :class="{'w-100 w-md-auto': isMobile}"
                                            @click="onClickAdd">
                                            <client-only>
...
import * as api from '~/composables/purchase/rv/rv.api'
...
const onClickUpdate = (id: string) => router.push('/purchase/rv/' + id)

                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <nuxt-link class="btn btn-sm btn-light text-primary"
                                :to="'/purchase/jo/view/' + joData.id" target="_blank">View JO details</nuxt-link>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <nuxt-link class="btn btn-sm btn-light text-primary"
                                :to="'/purchase/canvass/view/' + joData.canvass.id" target="_blank">View canvass
                                details</nuxt-link>
                        </div>
                ...
                <div class="row justify-content-center pt-3">
                    <div :class="{ 'col-lg-6': isJODetailForm, 'col-12': !isJODetailForm }">
                        ...
                        <div class="d-flex justify-content-between pt-3">
                            <div>
                                <nuxt-link class="btn btn-secondary" :to="`/purchase/jo/view/${joData.id}`">
                                    <client-only>

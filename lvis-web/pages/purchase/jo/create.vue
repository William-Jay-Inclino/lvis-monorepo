                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <nuxt-link v-if="joData.canvass" class="btn btn-sm btn-light text-primary"
                                        :to="'/purchase/canvass/view/' + joData.canvass.id" target="_blank">View
                                ...
                                <div class="mb-3">
                                    ...
                                    <client-only>
                                        <v-select @search="handleSearchEmployees" :options="supervisors" label="fullname" v-model="joData.supervisor"></v-select>
                                    </client-only>
                                ...
                                <div class="d-flex justify-content-between">
                                    <nuxt-link class="btn btn-secondary" to="/purchase/jo">
                                        <client-only>
...
import type { CreateJoInput } from '~/composables/purchase/jo/jo.types';
...
async function save() {
    ...
    if (response.success && response.data) {
        ...
        router.push(`/purchase/jo/view/${response.data.id}`);
    } else {
        Swal.fire({
            title: 'Error!',
            text: response.msg,

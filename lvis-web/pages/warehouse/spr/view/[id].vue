            ...
            <div v-if="!isLoadingPage && authUser" class="row justify-content-center">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <nuxt-link v-if="item.canvass_number" :to="'/warehouse/canvass/view/' + item.canvass_number">{{
                item.canvass_number }}</nuxt-link>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div v-if="item.meqs">
                                                        <nuxt-link :to="'/warehouse/meqs/view/' + item.meqs.id">{{
                                                    ...
                                                    <div v-if="hasPO">
                                                        <div v-for="meqsSupplier in item.meqs!.meqs_suppliers">
                                                            <nuxt-link v-if="meqsSupplier.po"
                                                                :to="'/warehouse/po/view/' + meqsSupplier.po.id">{{
...
const onClickAdd = () => router.push('/warehouse/spr/create')
const onClickUpdate = (id: string) => router.push('/warehouse/spr/' + id)

                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <nuxt-link class="btn btn-sm btn-light text-primary"
                                :to="'/warehouse/meqs/view/' + meqsData.id" target="_blank">View MEQS
                                details</nuxt-link>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <nuxt-link v-if="meqsData.rv" class="btn btn-sm btn-light text-primary"
                                :to="'/warehouse/rv/view/' + meqsData.rv.id" target="_blank">
                                View RV details
                            </nuxt-link>
                            <nuxt-link v-if="meqsData.spr" class="btn btn-sm btn-light text-primary"
                                :to="'/warehouse/spr/view/' + meqsData.spr.id" target="_blank">
                                View SPR details
                            </nuxt-link>
                            <nuxt-link v-if="meqsData.jo" class="btn btn-sm btn-light text-primary"
                                :to="'/warehouse/jo/view/' + meqsData.jo.id" target="_blank">
                                View JO details
                            </nuxt-link>
                        </div>

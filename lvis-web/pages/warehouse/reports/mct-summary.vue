            ...
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title text-warning">MCT Summary</h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
...
<script setup lang="ts">
    ...
    import * as mctApi from '~/composables/warehouse/mct/mct-reports.api'

    definePageMeta({
        name: ROUTES.MCT_SUMMARY_REPORT,
    ...
    async function onClickDownloadCsv() {
        ...
        const response = await mctApi.get_mct_summary_csv({
            startDate: filters.value.startDate,
            endDate: filters.value.endDate,
            authUser: authUser.value,
            apiUrl: WAREHOUSE_API_URL,
        ...
        if (response.csvUrl) {
            ...
            link.download = `mct-summary-${filters.value.startDate}_to_${filters.value.endDate}.csv`

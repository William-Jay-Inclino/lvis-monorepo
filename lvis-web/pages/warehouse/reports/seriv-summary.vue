            ...
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title text-warning">SERIV Summary</h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
...
<script setup lang="ts">
    ...
    import * as serivApi from '~/composables/warehouse/seriv/seriv-reports.api'

    definePageMeta({
        name: ROUTES.SERIV_SUMMARY_REPORT,

    ...
    <div class="card">
        <div class="card-body">
            <div v-if="!isLoadingPage">
                ...
                <h2 class="text-warning">Update Project</h2>
...
import type { CreateProjectInput, Project } from '~/composables/warehouse/project/project.types'
import Swal from 'sweetalert2'

definePageMeta({
    name: ROUTES.PROJECT_UPDATE,
...
async function onSubmit() {
    ...
    if (response.success && response.data) {
        ...
        router.push(`/warehouse/project/view/${response.data.id}`);

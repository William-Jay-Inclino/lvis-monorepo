    ...
    <div class="card">
        <div class="card-body">
            ...
            <div v-if="!isLoadingPage">
                <h2 class="text-warning">Search Project</h2>
                <hr>
...
const onClickViewDetails = (id: string) => router.push('/warehouse/project/view/' + id)
const onClickAdd = () => router.push('/warehouse/project/create')

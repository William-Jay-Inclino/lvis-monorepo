<template>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <h2 class="text-warning">Create Project</h2>
...
import type { CreateProjectInput } from '~/composables/warehouse/project/project.types'
...
const _initialFormData: CreateProjectInput = {
    name: '',
}

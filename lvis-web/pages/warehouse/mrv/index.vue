            ...
            <div v-if="!isLoadingPage && authUser">
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button v-if="canCreate(authUser, 'canManageMRV')" @click="onClickAdd" class="btn btn-primary float-end">
                        <i class="fas fa-plus"></i> Create MRV
                    </button>
                </div>
...
onMounted(async () => {
    ...
    const response = await mrvApi.fetchDataInSearchFilters()
...
async function search() {
    ...
    if (mrv.value) {
        const response = await mrvApi.findByMrvNumber(mrv.value.mrv_number)

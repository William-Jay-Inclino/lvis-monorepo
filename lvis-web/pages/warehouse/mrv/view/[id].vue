                            ...
                            <div class="col">
                                <div class="d-flex justify-content-center flex-wrap gap-2">
                                    <nuxt-link v-if="canSearch(authUser, 'canManageMRV')"
                                        class="btn btn-secondary" :class="{'w-100 w-md-auto': isMobile}" to="/warehouse/MRV">
                                        <client-only>
                                    ...
                                    <template v-if="!item.cancelled_at">
                                        <button v-if="isAdminOrOwner(item.created_by, authUser) && item.status === APPROVAL_STATUS.PENDING"
                                            class="btn btn-warning" :class="{'w-100 w-md-auto': isMobile}" @click="onCancelMRV()">
                                            <client-only>
                                        ...
                                        <button v-if="canCreate(authUser, 'canManageMRV')" class="btn btn-primary" :class="{'w-100 w-md-auto': isMobile}"
                                            @click="onClickAdd">
                                            <client-only>

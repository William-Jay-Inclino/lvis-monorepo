                            ...
                            Search Gas Slip
                                ...
                                <font-awesome-icon :icon="['fas', 'print']"/>
                                    ...
                                    <div v-if="!item.cancelled_at">
                                        <button v-if="isAdminOrOwner(item.created_by, authUser) && item.status !== APPROVAL_STATUS.APPROVED" class="btn btn-warning me-2"
...
import * as api from '~/composables/warehouse/gas-slip/gas-slip.api'
...
async function cancelGasSlip() {
    ...
    if (response.success) {
        ...
        router.push('/warehouse/gas-slip')
...
const onClickUpdate = (id: string) => router.push('/warehouse/gas-slip/' + id)

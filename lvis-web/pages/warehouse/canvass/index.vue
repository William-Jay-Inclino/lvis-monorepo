...
const onClickViewDetails = (id: string) => router.push('/warehouse/canvass/view/' + id)
// const onClickEdit = (id: string) => router.push('/warehouse/canvass/' + id)
const onClickAdd = () => router.push('/warehouse/canvass/create')

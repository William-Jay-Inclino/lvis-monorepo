...
const onClickGoToList = () => router.push(`/warehouse/supplier`);
const onClickAddNew = () => router.push(`/warehouse/supplier/create`);
const onClickUpdate = () => router.push(`/warehouse/supplier/${item.value?.id}`);

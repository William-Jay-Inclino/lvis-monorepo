        ...
        <div class="card">
            <div class="card-body">
                ...
                <div v-if="!isLoadingPage">
                    ...
                    <h2 class="text-warning">Sitios</h2>
                                        ...
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="bg-secondary text-white">Barangay</th>
...
const onClickCreate = () => router.push('/powerserve/sitio/create')
const onClickEdit = (id: string) => router.push('/powerserve/sitio/' + id)

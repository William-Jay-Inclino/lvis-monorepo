                ...
                <table class="table table-bordered table-sm small">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-muted">
                                <textarea rows="2" class="form-control form-control-sm text-muted" :value="rv.canvass.purpose" readonly/>
                            </td>
                        </tr>
                        <tr>
                            <td class="align-middle">Requisitioner Notes</td>
                            <td class="text-muted">
                                <textarea rows="2" class="form-control form-control-sm text-muted" :value="rv.canvass.notes" readonly/>
                            </td>
                        </tr>
                        <tr>
                            <td>Date</td>
                        ...
                        <tr>
                            ...
                            <td class="text-muted">
                                <textarea rows="2" class="form-control form-control-sm text-muted" :value="rv.notes" readonly/>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <table class="table table-bordered table-table-sm small">
                        ...
                        <tbody>
                            <tr v-for="i, count in rv.rv_approvers">
                                ...
                                <td v-if="!isBlankStatus(rv.status, i.status)" class="text-muted text-center align-middle no-wrap">
                    ...
                    <table class="table table-bordered table-sm small">
                        ...
                        <tbody>
                            <tr v-for="i, count in rv.canvass.canvass_items">
                                ...
                                <td class="align-middle text-muted no-wrap"> {{ i.item ? 'Stock' : 'Non-Stock' }} </td>
                                <td class="align-middle text-muted no-wrap"> {{ i.unit ? i.unit.name : 'N/A' }} </td>

            ...
            <div class="modal-content">
                ...
                <div class="modal-body" v-if="pendingApproval">
                    ...
                    <div class="mb-3" v-if="employee.is_budget_officer">
                        ...
                        <client-only>
                            <v-select data-testid="classification" @search="handleSearchClassifications" :options="classifications" label="name" v-model="classification"></v-select>
                        </client-only>
                    ...
                    <div class="mb-3" v-if="employee.is_finance_manager">
                        ...
                        <client-only>
                            <v-select data-testid="fund-source" @search="handleSearchAccounts" :options="accounts" label="name" v-model="fundSource"></v-select>
                        </client-only>
                ...
                <div class="modal-footer">
                    ...
                    <button data-testid="approve" @click="approve"

...
export const useComplaintStore = defineStore('complaint', {
    ...
    state: () => ({
        ...
        search_filters: {
            ...
            selected_complaint_status: null as ComplaintStatus | null,

            complaints: [] as Complaint[],
            selected_complaint: null as Complaint | null,
    ...
    getters: {
        ...
        complaint_statuses: (state) => {
            return state.search_filters.complaint_statuses
        },
    ...
    actions: {
        ...
        set_search_filters(payload: {
            ...
            const { complaint_statuses } = payload

            if(complaint_statuses){
                this.search_filters.complaint_statuses = complaint_statuses
            }

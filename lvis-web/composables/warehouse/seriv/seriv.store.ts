...
export const useSerivStore = defineStore('seriv', {
    ...
    getters: {
        ...
        serivs: (state) => {
            return state.search_filters.serivs
        },
        employees: (state) => {
    ...
    actions: {
        ...
        set_searched_results(payload: { items: SERIV[] }) {
        ...
        set_search_filters(payload: {
            ...
            const { serivs, employees } = payload
            
            if(serivs){
                this.search_filters.serivs = serivs 
            }

...
export const useOsrivStore = defineStore('osriv', {
    ...
    getters: {
        ...
        osrivs: (state) => {
            return state.search_filters.osrivs
        },
        employees: (state) => {
    ...
    actions: {
        ...
        set_searched_results(payload: { items: OSRIV[] }) {
        ...
        set_search_filters(payload: {
            ...
            const { osrivs, employees } = payload
            
            if(osrivs){
                this.search_filters.osrivs = osrivs 
            }

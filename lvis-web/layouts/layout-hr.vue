                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li v-if="canView('canManageEmployee', authUser)" class="nav-item">
                            <nuxt-link :class="{ active: $route.path.startsWith('/hr/employee') }" class="nav-link text-white" to="/hr/employee">Employee</nuxt-link>
                        </li>
                        <li v-if="canView('canManageDepartment', authUser)" class="nav-item">
                            <nuxt-link :class="{ active: $route.path.startsWith('/hr/department') }" class="nav-link text-white" to="/hr/department">Department</nuxt-link>
                        </li>

                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li v-if="canView('canManageTripTicket', authUser)" class="nav-item">
                            <nuxt-link class="nav-link text-white" to="/motorpool/trip-ticket">Trip Ticket</nuxt-link>
                        </li>
                        <li v-if="canView('canManageGasSlip', authUser)" class="nav-item">
                            <nuxt-link class="nav-link text-white" to="/motorpool/gas-slip">Gas Slip</nuxt-link>
                        </li>
                        <li v-if="canView('canManageVehicle', authUser)" class="nav-item">
                            <nuxt-link class="nav-link text-white" to="/motorpool/vehicle">Vehicle</nuxt-link>
                        </li>
